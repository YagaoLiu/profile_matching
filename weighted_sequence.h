...
class WeightedSequence {
	...
	friend PropertySuffixTree * build_index ( double z, bool quiet, vector<WeightedSequence>& W, std::ostream& out );
...
public:
    ...
    void build_zstring(double z, bool quiet, std::ostream& out);
    bool contains(std::string const& P) const;
    vector<int> occurrences(std::string const &P) const;
